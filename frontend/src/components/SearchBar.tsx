...
const formSchema = z.object({
    searchQuery: z.string({
        required_error: "Restaurant name is rrequired"
    })
});
...
const SearchBar = ({onSubmit, onReset,placeholder }: Props)=> {
    ...
    return(
        <Form{...form}>
            ...
            {form.formState.isDirty && (<Button type ="button" variant="outline" onClick = {handleReset}className="rounded-full">Clear</Button>)}
