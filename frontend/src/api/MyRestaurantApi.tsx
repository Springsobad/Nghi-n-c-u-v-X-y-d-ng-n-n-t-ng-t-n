...
export const useCreateMyRestaurant = () => {
    ...
    const createMyRestaurantRequest = async (
      ...
      if (!response.ok) {
        ...
        throw new Error(errorMessage || "Failed to create restaurant");
    ...
    // }
    if (isSuccess && data) {
      toast.success(`Restaurant created: ${data.restaurantName}`);
    }
    // if (error) {
    //   toast.error(error instanceof Error ? error.message : "Unable to create restaurant");
...
export const useUpdateMyRestaurant = () => {
  ...
  if(error) {
    toast.error(error instanceof Error ? error.message : "Unable to upadted restaurant");
  }
